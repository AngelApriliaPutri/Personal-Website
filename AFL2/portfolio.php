    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>Unveiling My Portfolio</p>
        </div>

        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data="*" class="filter-active">All</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gmbr1.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gmbr2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>2</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gmbr3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>3</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gmbr4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>4</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gmbr5.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>5</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gmbr6.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>6</h4>
              </div>
            </div>
